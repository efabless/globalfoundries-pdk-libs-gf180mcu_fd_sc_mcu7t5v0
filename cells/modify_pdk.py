...
for cells in pdk_cells:
    ...
    if os.path.isdir(cells) and cells != "udp":
        func_pp_file_path = glob.glob(f"{cells}/gf180mcu_fd_sc_mcu7t5v0__{cells}*.functional.pp.v")[0]
        func_file_path = func_pp_file_path.replace(".pp", "")
        beh_pp_file_path = glob.glob(f"{cells}/gf180mcu_fd_sc_mcu7t5v0__{cells}*.behavioral.pp.v")
        beh_file_path = glob.glob(f"{cells}/gf180mcu_fd_sc_mcu7t5v0__{cells}*.behavioral.v")
        base_file_path = f"{cells}/gf180mcu_fd_sc_mcu7t5v0__{cells}_func.v"
        ...
        for num, line in enumerate(ref_file, 1):
            if num <= comment_line:
                ...
                base_file.write("\n")
                base_file.write("`ifndef " + f"GF180MCU_FD_SC_MCU7T5V0__{cells}_V\n".upper())
                base_file.write("`define " + f"GF180MCU_FD_SC_MCU7T5V0__{cells}_V\n\n".upper())
                base_file.write(f"`include \"../udp/udp_primitives.v\"\n\n")
                ...
                if num < udp_line:
                    ...
                    if "UDP_GF018hv5v_mcu_sc7_TT_1P8V_25C_verilog_nonpg_MGM_N_IQ_FF_UDP" in line:
                        base_file.write(f"	gf180mcu_fd_sc_mcu7t5v0__N_IQ_FF_udp{args_udp}\n")
                    elif "UDP_GF018hv5v_mcu_sc7_TT_1P8V_25C_verilog_nonpg_MGM_HN_IQ_FF_UDP" in line:
                        base_file.write(f"	gf180mcu_fd_sc_mcu7t5v0__HN_IQ_FF_udp{args_udp}\n")
                    elif "UDP_GF018hv5v_mcu_sc7_TT_1P8V_25C_verilog_nonpg_MGM_N_IQ_LATCH_UDP" in line:
                        base_file.write(f"	gf180mcu_fd_sc_mcu7t5v0__N_IQ_LATCH_udp{args_udp}\n")
                    elif "UDP_GF018hv5v_mcu_sc7_TT_1P8V_25C_verilog_nonpg_MGM_HN_IQ_LATCH_UDP" in line:
                        base_file.write(f"	gf180mcu_fd_sc_mcu7t5v0__HN_IQ_LATCH_udp{args_udp}\n")
        ...
        for i in range(0,len(beh_pp_file_path)):
            ...
            for num, line in enumerate(beh_pp_file, 1):
                if line.startswith("//"):
                    ...
                    begin_spec_line = num
                elif line.strip().startswith("gf180mcu_fd_sc_mcu7t5v0__"):
            ...
            for num, line in enumerate(beh_file, 1):
                if num <= comment_line:
                    ...
                    beh_base_file.write("\n")
                    beh_base_file.write("`ifndef " + f"GF180MCU_FD_SC_MCU7T5V0__{cell_name}_V\n".upper())
                    beh_base_file.write("`define " + f"GF180MCU_FD_SC_MCU7T5V0__{cell_name}_V\n\n".upper())
                    beh_base_file.write(f"`include \"gf180mcu_fd_sc_mcu7t5v0__{cells}_func.v\"\n\n")
                ...
                elif line.strip().startswith("gf180mcu_fd_sc_mcu7t5v0__") and count == 0:
                    beh_base_file.write("\n")
                    args = re.search(".*inst(\(.*;)", line).group(1)
                    beh_base_file.write("`ifdef USE_POWER_PINS\n")
                    beh_base_file.write(f"  gf180mcu_fd_sc_mcu7t5v0__{cells}_func gf180mcu_fd_sc_mcu7t5v0__{cells}_inst{args_power}\n")
                    beh_base_file.write("`else // If not USE_POWER_PINS\n")
                    beh_base_file.write(f"  gf180mcu_fd_sc_mcu7t5v0__{cells}_func gf180mcu_fd_sc_mcu7t5v0__{cells}_inst{args}\n")
                    beh_base_file.write("`endif // If not USE_POWER_PINS\n\n")
