    ...
    if os.path.isdir(cells) and cells != "udp":
        ...
        for num, line in enumerate(pp_file, 1):
            if line.startswith("//"):
                ...
                if "UDP_GF018hv5v_mcu_sc7_TT_5P0V_25C_verilog_pg_MGM_N_IQ_FF_UDP" in line:
                    udp_data = "gf180mcu_fd_sc_mcu7t5v0__N_IQ_FF_udp"
                elif "UDP_GF018hv5v_mcu_sc7_TT_5P0V_25C_verilog_pg_MGM_HN_IQ_FF_UDP" in line:
                    udp_data = "gf180mcu_fd_sc_mcu7t5v0__HN_IQ_FF_udp"
                elif "UDP_GF018hv5v_mcu_sc7_TT_5P0V_25C_verilog_pg_MGM_N_IQ_LATCH_UDP" in line:
                    udp_data = "gf180mcu_fd_sc_mcu7t5v0__N_IQ_LATCH_udp"
                elif "UDP_GF018hv5v_mcu_sc7_TT_5P0V_25C_verilog_pg_MGM_HN_IQ_LATCH_UDP" in line:
                    udp_data = "gf180mcu_fd_sc_mcu7t5v0__HN_IQ_LATCH_udp"
        pp_file.close()
